...
constructor TCryptSimple.create;
begin
  NumeroSerial   := '';
  DataVencimento := '';
  NomeEmpresa    := '';
...
begin
  ...
  NumeroSerial   := GetSerialNumber(ACertContext);
  DataVencimento := dateToStr(GetNotAfter(ACertContext));
  NomeEmpresa    := GetIssuerName(ACertContext);
